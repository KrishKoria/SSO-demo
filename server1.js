  ...
  res.send(`
    <html>
      <body>
        ...
        <iframe src="http://localhost:3002/sso-login?token=${token}" style="display:none;"></iframe>
        <script>
    ...
    res.send(`
      <html>
        <body>
          ...
          <iframe src="http://localhost:3002/sso-logout?token=${token}" style="display:none;"></iframe>
          <script>
            setTimeout(() => window.location.href = "/", 1000);
          </script>
        </body>
